...
namespace TyphenApi.Type.Submarine.Battle
{
    ...
    {
        protected static readonly SerializationInfo<Finish, long> winnerUserId = new SerializationInfo<Finish, long>("winner_user_id", false, (x) => x.WinnerUserId, (x, v) => x.WinnerUserId = v);
